...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MilanoGreenBackEnd.ServiceApi();
  });
    ...
    describe('ServiceApi', function() {
      describe('serviceGET', function() {
        it('should call serviceGET successfully', function(done) {
          // TODO: uncomment, update parameter values for serviceGET call and complete the assertions
          /*
          var opts = {};
          opts.limit = 56;
          opts.offset = 56;

          instance.serviceGET(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('serviceServiceIdGET', function() {
        it('should call serviceServiceIdGET successfully', function(done) {
          // TODO: uncomment, update parameter values for serviceServiceIdGET call and complete the assertions
          /*
          var serviceId = 789;

          instance.serviceServiceIdGET(serviceId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('serviceServiceIdRelatedEventsGET', function() {
        it('should call serviceServiceIdRelatedEventsGET successfully', function(done) {
          // TODO: uncomment, update parameter values for serviceServiceIdRelatedEventsGET call and complete the assertions
          /*
          var serviceId = 789;

          instance.serviceServiceIdRelatedEventsGET(serviceId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('serviceServiceIdRelatedPeopleGET', function() {
        it('should call serviceServiceIdRelatedPeopleGET successfully', function(done) {
          // TODO: uncomment, update parameter values for serviceServiceIdRelatedPeopleGET call and complete the assertions
          /*
          var serviceId = 789;

          instance.serviceServiceIdRelatedPeopleGET(serviceId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
