...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MilanoGreenBackEnd.EventApi();
  });

  describe('(package)', function() {
    describe('EventApi', function() {
      describe('eventEventIdGET', function() {
        it('should call eventEventIdGET successfully', function(done) {
          // TODO: uncomment, update parameter values for eventEventIdGET call and complete the assertions
          /*
          var eventId = 789;

          instance.eventEventIdGET(eventId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('eventEventIdRelatedServicesGET', function() {
        it('should call eventEventIdRelatedServicesGET successfully', function(done) {
          // TODO: uncomment, update parameter values for eventEventIdRelatedServicesGET call and complete the assertions
          /*
          var eventId = 789;

          instance.eventEventIdRelatedServicesGET(eventId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
